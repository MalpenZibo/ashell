//! D-Bus layer for the tray: StatusNotifierWatcher server we host, plus
//! proxies for StatusNotifierItem and com.canonical.dbusmenu. Ported from
//! ashell (iced futures swapped for the futures crate, PartialEq derives
//! added so layouts can live inside reactive signals).
