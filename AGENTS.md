...
- **Compositor abstraction:** `Compositor` trait (generic-Wayland defaults) with Hyprland, Niri, and generic implementations routed through a `Backend` enum, auto-detected at runtime.
