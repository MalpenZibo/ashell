...
AI-assisted contributions are welcome in this project. If you use AI tools to help write code, documentation, or other contributions, that is perfectly fine — provided the result meets the same quality standards as any other contribution.

However, we ask that you **use only top-tier, frontier-class models** (e.g., Claude Opus 4.6 or equivalent). Lower-capability models tend to produce subtly incorrect code, miss architectural conventions, or introduce patterns that don't fit the codebase. Contributions that appear to be bulk-generated by weaker models without adequate review will be asked to be revised.
